...
В криптографии сложно получить преимущество потому что любой желающий может
форкнуть проект. Тем не менее некоторые протоколы DeFi все еще доминируют
спустя годы, несмотря на подражателей. Давайте посмотрим, почему.
...
Бизнес создает новую модель. Действующие компании не могут применить ее,
так как это уничтожит часть или весь их существующий бизнес.
...
бассейн ("Curve pool") получит больше вознаграждений.
...
Посмотрите на [defiwars.xyz](https://www.defiwars.xyz/), чтобы не отставать от текущей повестки.
...
#### a) Общая заблокированная стоимость (TVL)
...
1. BNB - крупнейшая CEX (централизованная биржа) в мире
